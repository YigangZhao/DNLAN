...
parser = argparse.ArgumentParser(description='NLSN')
...
parser.add_argument('--windows_size', type=int, default=94)
...
parser.add_argument('--n_local_heads', type=int, default=0)

# LFLSN
parser.add_argument('--n_hashlength', type=int, default=0)
...
# Log specifications
parser.add_argument('--save_dir', type=str, default='..', help='dir to save')
...
parser.add_argument('--ssim', action='store_true',
                    help='evaluated by SSIM metrics')
