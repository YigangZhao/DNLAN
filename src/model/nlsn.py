...
class NLSN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        m_body = [attention.NonLocalSparseAttention(
            channels=n_feats, chunk_size=args.chunk_size, n_hashes=args.n_hashes, reduction=4, res_scale=args.res_scale, debug=self.debug)]
